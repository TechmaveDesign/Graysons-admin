                            ...
                            <div class="enquiryRight_header_data TaskAction_wrapper ">
                               ...
                               <!-- <a href="procurement-shortlisted-supplier-add.php">
                                ...
                                <div class="enquiryID_container">
                                    <div class="EnquiryID">Order Status</div>
                                    <div class="IDButton approval_status_update">
                                        <button type="button" class="SourceDataBtn approved" id="approvalStatusBtn">Order Placed</button>
                                    </div>
                                </div>
                                <!-- <div class="ActionBtn generate-invoice-btn p-0" id="generateInvoiceBtn">
                                    
                                <button class="CreateCst_button" id="ConfirmBtn">
                                ...
                                <div class="tab-content tabContent_hiddenStyle nobtPadding">
                                    ...
                                    <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            <div class="OrderDetail_left_header">
                                                    <div class="Order_title_container">
                                                        <h1 class="OrderID_title">Track Shipment</h1>
                                                    </div>
                                                    <div class="rightInvoices_action">
                                                    <button class="invoice-btn FlexbtnStyleBtn" type="button" id="DownloadInvoice" style="display: none;">
                                                    <iconify-icon icon="hugeicons:invoice-01"></iconify-icon> Download Invoice
                                                    </button>

                                                    <button class="invoice-btn FlexbtnStyleBtn" type="button" data-bs-toggle="modal" data-bs-target="#uploadInvoice"><iconify-icon icon="material-symbols-light:upload"></iconify-icon> Upload Invoice</button>
                                                    </div>
                                                </div>
                                                <div class="OrderItemsDetails">
                                                    <div class="tracking-container">
                                                        ...
                                                        <div class="progress-bar">
                                                            <div class="stage success" data-stage="Order Placed" style="background-color: rgb(76, 175, 80);"></div>
                                                            <div class="stage processing" data-stage="Order Shipped" style="background-color: rgb(255, 202, 40);"></div>
                                                            <div class="stage" data-stage="Out For Delivery" style="background-color: rgb(74, 74, 74);"></div>
                                                            <div class="stage" data-stage="Delivered" style="background-color: rgb(74, 74, 74);"></div>
                                                        </div>
                                                        <div class="orderdate_and_action">
                                                            <div class="shipping-date"  data-bs-toggle="modal" data-bs-target="#createfolderModal">
                                                                <iconify-icon icon="mynaui:arrow-right-waves"></iconify-icon> Expected Delivery date: <div class="ShippingDate_label">Apr 23, 2024</div>
                                                            </div>
                                                            <button class="ship-button" type="button" data-bs-toggle="modal" data-bs-target="#createfolderModal">Mark as Order Placed</button>
                                                        </div>
                                                    </div>
            ...
            <div class="actionBtnSection text-end">
             <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              ...
              <div class="iconImageSection">
                <img src="dist/img/newimages/calendar.png" alt="" class="deliveryDateImg">
                <h5>Enter Expected Delivery Date</h5>
                <p>Effortlessly set and manage expected delivery date</p>
              </div>
              <div class="form-group">
                <!-- <label class="form-label">Due Date</label> -->
                <input class="form-control customdataPicker flatpickr-input active" type="text" name="" value="01/06/2024" readonly="readonly">
...
<div class="addEnquiry">
  <form action="#">
    <div class="modal fade" id="uploadInvoice" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-body">
            <div class="sectionCreateBox">
            <div class="actionBtnSection text-end">
             <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              ...
              <div class="iconImageSection">
                <img src="dist/img/newimages/bill.png" alt="" class="deliveryDateImg">
                <h5>Upload Invoice</h5>
                <p>Effortlessly upload and manage your invoices.</p>
              </div>
              <div class="form-group">
                <!-- <label class="form-label">Due Date</label> -->
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btnContinueProcess').forEach(function(button) {
      button.addEventListener('click', function(event) {
        ...
        // Simulate a delay before dismissing modal
        setTimeout(function() {
          // Hide the modals when applicable
          ['createfolderModal', 'uploadInvoice'].forEach(function(modalId) {
          ...
          // If inside EditGroupModal, stop further execution
          if (button.classList.contains('saveAndContinue')) {
            return;
          }

          // Show the "Download Invoice" button if the modal is "uploadInvoice"
          const isInsideUploadInvoice = button.closest('#uploadInvoice');
          if (isInsideUploadInvoice) {
            downloadBtn.style.display = 'block';
          }

          // Simulate form submission without reloading
          const form = button.closest('form');
          if (form) {
            console.log('Form submission simulated!', form); // Simulated submission
          }
        }, 1000); // Delay before dismissing modal
      });
    });

    // Add click event to "Download Invoice" button to show SweetAlert
...
<script>
    document.getElementById('ConfirmBtn').addEventListener('click', function() {
        Swal.fire({
            ...
            text: 'The selected supplier has been confirmed for the purchase of the item.',
            confirmButtonText: 'OK',
