    ...
    <div class="hk-pg-body homebodyContainer">
        <div class="tab-content">
            <div class="tab-pane fade show active" id="tab_block_1">
                <div class="row">
                    <div class="col-xxl-12 col-lg-12 col-md-12 mb-md-12 ">
                                ...
                                <div class="flex-grow-1 ms-lg-3 userdashcards">
                                    <div class="row">
                                        <div class="col-xxl-3 col-sm-6 mb-xxl-0 mb-3 cardDash">
                                            <div class="dashtileFlexWrap">
                                                ...
                                                <div class="IconBoxTiles">
                                                    <iconify-icon icon="material-symbols-light:tenancy-outline">
                                                    </iconify-icon>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xxl-3 col-sm-6 cardDash">
                                            ...
                                            <a href="tenancy-renewal.php" class="dashtileLink">
                                                <div class="dashtileFlexWrap">
                                                    <div class="dashtile_titlewrap">
                                                        <span class="d-block fw-medium fs-7 tiledashTitle">Tenancy
                                                            Endings</span>
                                                        <div class="d-flex align-items-center">
                                                            <span
                                                                class="d-block fs-4 fw-medium text-dark mb-0">54</span>
                                                            <span class="badge badge-sm badge-soft-danger ms-1">
                                    ...
                                    <div class="row dashrowcare2">
                                        <div class="col-xxl-3 col-sm-6 mb-xxl-0 mb-3 cardDash">
                                            ...
                                            <div class="dashtileFlexWrap">
                                                <div class="dashtile_titlewrap">
                                                    <span class="d-block fw-medium fs-7">Total Tenancies</span>
                                                    <div class="d-flex align-items-center">
                                                        <span class="d-block fs-4 fw-medium text-dark mb-0">8709</span>
                                                        <span class="badge badge-sm badge-soft-success ms-1">
                                                            <i class="bi bi-arrow-up"></i> 7.5% <i
                                                                class="bi bi-arrow-down"></i>
                                            ...
                                            <div class="dashtileFlexWrap">
                                                <div class="dashtile_titlewrap">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="badge badge-sm badge-soft-success ms-1">
                                                            <i class="bi bi-arrow-up"></i> 7.2% <i
                                                                class="bi bi-arrow-down"></i>
                                        ...
                                        <div class="col-xxl-3 col-sm-6 mb-xxl-0 mb-3 cardDash">
                                            ...
                                            <div class="dashtileFlexWrap">
                                                <div class="dashtile_titlewrap">
                                                    <span class="d-block fw-medium fs-7">Total Inventory</span>
                                                    <div class="d-flex align-items-center">
                                                        <span class="d-block fs-4 fw-medium text-dark mb-0">1989</span>
                                                        <span class="badge badge-sm badge-soft-danger ms-1">
                                                            <i class="bi bi-arrow-up"></i> 0.2% <i
                                                                class="bi bi-arrow-down"></i>
                            ...
                            <div class="card-header card-header-action">
                                ...
                                <div class="Header_right_Filters">
                                    <div class="card-action-wrap">
                                        <a href="tenancies.php" class="btn btn-sm btn-outline-light ms-3"><span><span
                                                    class="icon"><span class="feather-icon"><i
                                                            data-feather="eye"></i></span></span><span
                                                    class="btn-text">View All View Tenancies</span></span></a>
                                                    ...
                                                    <div class="d-flex align-items-center ActionDropdown">
                                                        <div class="d-flex">
                                                            ...
                                                            <a href="tenancy.php"
                                                                ...
                                                                data-bs-original-title="View Tenancy"><span
...
<div id="AddHubEvent" class="modal customwizard_formStyle sm_modalCustom fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form action="tenancy-dashboard-panel.php" method="post" id="wizardForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="todo-input" class="form-control" rows="3"
                                                cols="30"></textarea>
                                        </div>
                                    </div>
...
<!-- edit task modal -->
<div id="EditTaskdah" class="modal customwizard_formStyle sm_modalCustom fade" tabindex="-1" role="dialog"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form action="tenancy-dashboard-panel.php" method="post" id="wizardForm">
            <div class="modal-content">
                            ...
                            <div class="wizardstep_innerContainer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-label">Duration</label>
                                            <select name="" id="durationSelect2" class="form-control select2">
                                                <option value="" selected disabled readonly>Select an Option</option>
                                                <option value="15 Min">15 Min</option>
                                                <option value="20 Min">20 Min</option>
                                                <option value="1 hour">1 hour</option>
...
<script>
    function addItem() {
        ...
        deleteButton.classList.add('btn', 'btn-icon', 'btn-sm', 'badge', 'badge-sm', 'badge-soft-danger',
            'delete-todo');
...
<script>
    $(document).ready(function() {
        ...
        $('.customTile_field').hide();
        // Show/hide custom field based on selected option
        $('#durationSelect2').on('change', function() {
            if ($(this).val() === 'Custom') {
                $('.customTile_field').show();
            } else {
                $('.customTile_field').hide();
