                                                ...
                                                <div class="card-header card-header-action">
                                                    ...
                                                    <div class="cardRightDetail_boxContainer">
                                                        <div class="flexcheckColumn">
                                                            <span
                                                                class="badge rounded-pill bg-outline-success">Quote
                                                                Requested</span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="tab-content tasktab_content mt-3 nobtPadding">
                                                        ...
                                                        <div class="tab-pane fade"
                                                            id="Archived_Compliances_Quotation">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="contact-list-view">
                                                                    <table class="table common-datatable nowrap w-100">
                                                        ...
                                                        <div class="tab-pane fade" id="Accepted_Quotation">
                                                            <table class="table common-datatable nowrap w-100">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Contractor Name</th>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <a
                                                                                href="view-all-property-quotations.php">David
                                                                                Wilson</a>
                                                                        </td>
                                                                        <td>
                                                                            <div class="LongMesage_container">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a
                                                                                href="view-all-property-quotations.php">Emma
                                                                                Johnson</a>
                                                                        </td>
                                                                        <td>
                                                                            <div class="LongMesage_container">
