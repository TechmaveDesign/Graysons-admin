...
<head>
    ...
    <title>Graysons Admin Login </title>
								...
								<form class="w-100">
									<div class="row">
										<div class="col-lg-10 mx-auto">
											...
											<div class="row gx-3">
												...
												<div class="form-group col-lg-12">
													<div class="form-label-group">
														...
														<a href="reset-password.php" class="fs-7 fw-medium">Forgot Password ?</a>
													</div>
											...
											<a href="index.php" class="btn btn-primary btn-uppercase btn-block">Login</a>
			...
			<div class="hk-footer">
				<footer class="container-xxl footer">
					<div class="row">
						...
						<div class="col-xl-4">
                            <p class="footer-text rightft_privacypl">
                            <a href="#" class="footer-extr-link link-default"><span class="feather-icon"><i data-feather="external-link"></i></span><u>Privacy Policy</u></a>
                            <span class="footer-link-sep">|</span>
                            <a href="#" class="footer-extr-link link-default"><span class="feather-icon"><i data-feather="external-link"></i></span><u>T&C</u></a>
                            </p>
