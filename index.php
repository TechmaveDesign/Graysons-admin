						...
						<div class="card card-border mb-0  mt-3">
							<div class="card-header card-header-action">
								...
								<div class="card-action-wrap">
									...
									<div class="dropdown-menu dropdown-menu-end">
										<a class="dropdown-item" href="#">View All Todo</a>
									</div>
								</div>
							</div>
							<div class="card-body text-center">

								<div class="sectionAddon_todo">
									<div class="add-list">
										<textarea id="todo-input" class="form-control" rows="3" cols="30"></textarea>
										
									</div>
									<div class="AddtodoButton_container">
									<button type="submit" class=" addtodobtn  text-white"
											id="add-button"><iconify-icon icon="heroicons:plus-16-solid"></iconify-icon> Add</button>
									</div>
								</div>
								<div class="list-container dashTodoList" id="list-container">
									<!-- Dummy todo items -->
									<div class="item advance-list-item single-task-list">
										<p>Complete assignment</p>
										<div class="buttons">
											<button class="btn btn-icon btn-sm badge badge-sm badge-soft-danger delete-todo"><i
													class="ph-trash"></i></button>
											<button class="btn btn-icon btn-sm badge badge-sm badge-soft-success edit-todo"><i
