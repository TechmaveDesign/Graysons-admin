...
<div class="subHeaderContainer">
    <ul class="nav flex-column">
        ...
        <li class="nav-item ">
            <a class="nav-link" href="staff-users.php"><span class="nav-link-text">Staff</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="tenant-users.php"><span class="nav-link-text">Tenants</span></a>
        </li>
        <li class="nav-item">
        ...
        <!-- <li class="nav-item">
            <a class="nav-link" href="unverified_emails.php"><span class="nav-link-text">
                    Emails not Verified</span></a>
        </li> -->
