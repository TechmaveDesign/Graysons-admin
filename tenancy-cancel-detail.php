                    ...
                    <div class="d-flex align-items-center">
                        <div class="dropdown">
                            <a class="contactapp-title link-dark" href="##" role="button">
                                <h1>Tenancy Cancellation Request Detail</h1>
                            </a>

                        </div>
                        <div class=" ms-3">
                            <a href="tenancy-cancel-request.php" class="btn btn-sm cmnbackbtn btn-outline-secondary ">
                                            ...
                                            <div class="card card-border mb-lg-4 mb-3">
                                                ...
                                                <div class="card-body custombodyPadding">
                                                    ...
                                                    <!-- <div class="flex-1 CustomFlex_style ">
                                                        ...
                                                        <div class="ticInfo_Item w-100" >
                                                                <div class="d-block TicketDetails_info_title ">
                                                                    Tenant Name
                                                                </div>
                                                                <div class="d-block text-capitalize fs-7 propertyUrlStyle">
                                                                    <a href="view-tenant-details.php" target="_blank">Morgan Freeman	
                                                                    </a></div>
                                                            </div>
                                                        </div>
                                                        <div class="flex-1 border-end CustomFlex_style">
                                                            <div class="ticInfo_Item">
                                                               ...
                                                               Flat</span>
                                                                <span 
                                                                    ...
                                                                    <span
                                                                        class="badge badge-soft-success  my-1  me-2">FLAT 1 </span></span>
                                                            </div>
                                                        </div>
                                                        <!-- <div class="flex-1 border-end CustomFlex_style">
                                                            <div class="ticInfo_Item">
                                                        ...
                                                        <div class="flex-1 border-end CustomFlex_style">
                                                            <div class="ticInfo_Item">
                                                                ...
                                                                <span
                                                                    class="d-block text-capitalize ticketdetailinfo_data">
                                                                    <span
                                                                        class="badge badge-soft-success  my-1  me-2">Bedroom A</span></span>
                                                            </div>
                                                        </div>
                                                        <!-- <div class="flex-1 border-end CustomFlex_style">
                                                            <div class="ticInfo_Item">
                                                        ...
                                                        <div class="flex-1 border-end CustomFlex_style">
                                                            <div class="ticInfo_Item">
                                                                ...
                                                                <span
                                                                    class="d-block text-capitalize ticketdetailinfo_data">
                                                                    <span
                                                                        class="badge badge-soft-success  my-1  me-2">Student</span></span>
                                                            </div>
                                                        </div>
                                                        <div class="flex-1 border-end CustomFlex_style">
                                                            <div class="ticInfo_Item">
                                                        ...
                                                        <div class="flex-1 border-end CustomFlex_style">
                                                            <div class="ticInfo_Item">
                                                                <span class="d-block TicketDetails_info_title">
                                                                   End tenancy Date</span>
                                                                <span
                                                                    class="d-block text-capitalize ticketdetailinfo_data">
                                                                    <span
                                                                        class="badge badge-soft-success  my-1  me-2">30 March, 2025</span></span>
                                                            </div>
                                                        </div>
    ...
    function handleApproveClick() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire('Rejected Successfully!', '', 'error');
                statusBtn.textContent = 'Rejected';
                statusBtn.classList.remove('pending');
                statusBtn.classList.add('RejectReq');
            }
        });
    }
</script>
