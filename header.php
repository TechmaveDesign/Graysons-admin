				...
				<div class="menu-content-wrap">
					...
					<div class="menu-group">
						...
						<ul class="navbar-nav flex-column">
																	...
																	<ul id="dash_invoice"
																		...
																		<li class="nav-item">
																			<ul class="nav menu-dropdown flex-column">
																				...
																				<li class="nav-item">
																					<a href="stripe-dashboard.php"
																						class="nav-link"
																						data-key="dispatch-invoices"><span
																							class="nav-link-text">Dashboard Overview</span></a>
																				</li>
																				<li class="nav-item">
																					<a href="stripe-rent-advance.php"
																						class="nav-link"
																						data-key="view-invoices"><span
																							class="nav-link-text">Advance Rent Payments</span>
																						<!-- <span
							...
							<!-- email-templates.php -->
							<li class="nav-item">
								<a class="nav-link sidecolor_System" href="system-configuration.php">
									<span class="nav-icon-wrap">
										<span class="svg-icon">
					...
					<div class="menu-group">
						...
						<ul class="navbar-nav flex-column">
							...
							<li class="nav-item">
								<a class="nav-link sidecolor_disclaimer" href="manage-policy.php">
									<span class="nav-icon-wrap">
										<span class="svg-icon">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M12 8h.008M12 16v-5m10 1c0 5.523-4.477 10-10 10S2 17.523 2 12S6.477 2 12 2s10 4.477 10 10"/></svg>
										</span>
									</span>
									<span class="nav-link-text">Manage Policies</span>
								</a>
								<i class="fa fa-circle text-danger-glow blink sidenabBlinker"></i>
							</li>
						</ul>
