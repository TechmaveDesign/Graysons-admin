                    ...
                    <header class="contact-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class=" ms-3">
                                ...
                                <a href="system-configuration.php"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="Contact" class="form-label">Template Title</label>
                                                        <input type="phone" class="form-control" id="Contact" value="Welcome Template">
                                                    </div>

                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="Contact" class="form-label">Upload Template Content Document</label>
