                        ...
                        <div class="d-flex align-items-center">
                            <div class="dropdown">
                                <a class="contactapp-title link-dark" href="##" role="button">
                                    <h1>All Schedule Inspection</h1>
                                </a>

                            </div>
                            <div class=" ms-3">
                                <a href="property-schedule-inspection.php" class="btn btn-sm cmnbackbtn btn-outline-secondary ">
                                ...
                                <ul
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#Details">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text">All Schedule Inspection</span>
                                            </div>
                                        </a>
                                    </li>
                                                      ...
                                                      <table class="table common-datatable nowrap w-100">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Upcoming Inspection date</th>
                                                                <th>Start Time</th>
                                                                <th>End Time</th>
                                                                <th>Status</th>
                                                                <th>Actions</th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center ActionDropdown">
                                                                        <div class="d-flex">
                                                                            <a href="inspection-detail.php" class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover">
                                                                                <span class="icon">
