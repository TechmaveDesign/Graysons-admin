                                                        ...
                                                        <div class="flex-1 border-end CustomFlex_style">
                                                            <div class="ticInfo_Item">
                                                                ...
                                                                <span
                                                                    class="d-block text-capitalize ticketdetailinfo_data">
                                                                    <span
                                                                        class="badge badge-soft-success  my-1  me-2">Maintenance
                                                                        Ticket</span></span>
                                                            </div>
                                                        </div>
                                                        <div class="flex-1 border-end CustomFlex_style">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="" id="" class="form-control select2">
                                                                    ...
                                                                    <option value="1189">Utilities &amp; Services
                                                                    </option>
                                                                    <option value="1194">Pests/Vermin</option>
                                                                    <option value="1198">Shared/Communal Facilities
                                                                    </option>
                                                                    ...
                                                                    <option value="1255">Kevin (Electrician)
                                                                    </option>
                                                                    <option value="1267">Garry (Electrician)
                                                                    </option>
                                                                    <option value="1273">UK Lifts</option>
                                                                    <option value="1274">MacDonald Martin</option>
                                                                    <option value="1279">GEMS (Peter Goldwater)
                                                                    </option>
                                                                    ...
                                                                    <option value="1296">Ashbrooke Audio Visual
                                                                    </option>
                                                                    <option value="1298">Computers/Printers</option>
                                                                    <option value="1299">Lights</option>
                                                                    <option value="1300">Routine Cleaning</option>
                                                                    <option value="1302">Property Inspection
                                                                    </option>
                                                                    <option value="1303">Portable Heaters</option>
                                                                    <option value="1307">Hot Water</option>
                                                                    <option value="1308">Service Report
                                                                        Recommendations</option>
                                                                    <option value="1309">Routine Fire Alarm Testing
                                                                    </option>
                                                                    <option value="1310">Routine Emergency Light
                                                                        Testing</option>
                                                                    <option value="1311">Legionella Test</option>
                                                                    <option value="1312">Fire Extinguinsher Check
                                                                    </option>
                                                                    <option value="1315">CG Plumbing and Heating
                                                                    </option>
                                                                    <option value="1316">Check Out Appointment
                                                                    </option>
                                                                    <option value="1317">Check-In Appointment
                                                                    </option>
                                                                    ...
                                                                    <option value="1323">Expansion Vessel Inspection
                                                                    </option>
                                                                    <option value="1324">Late Payment Charge
                                                                    </option>
                                                                    <option value="1325">Rent</option>
                                                                    <option value="1326">General Enquiries</option>
                                                                    <option value="1327">Cancellation of Tenancy
                                                                        Contract</option>
                                                                    <option value="1328">Marketing</option>
                                                                    <option value="1329">Emergency Call Out</option>
                                                                    <option value="1330">Student Exemption
                                                                        Certificates</option>
                                                                    ...
                                                                    <option value="1352">Laundry Credit Cards
                                                                    </option>
                                                                    <option value="1353">Unable to Clean</option>
                                                                    <option value="1354">Tenancy Renewal</option>
                                                                    <option value="1356">Monthly Washing Machine
                                                                        Clean</option>
                                                                    <option value="1357">Order Cleaning Products
                                                                    </option>
                                                                    <option value="1359">Require Vacuum</option>
                                                                    <option value="1360">Post Tenancy Key Return
                                                                    </option>
                                                                    <option value="1361">Self Isolation</option>
                                                                    <option value="1365">Presentation Room Leazes
                                                                        Terraces Reservation</option>
                                                                    <option value="1371">PAT Testing</option>
                                                                    <option value="1373">Overtime Claim Back
                                                                    </option>
                                                                    <option value="1374">Sick Leave</option>
                                                                    <option value="1375">Guest Overnight Stay
                                                                    </option>
                                                                    <option value="1376">Green Push Button</option>
                                                                    <option value="1379">End of Term Departure
                                                                    </option>
                                                                    <option value="1380">Emergency On Call</option>
                                                                    <option value="1381">Lock Laundry room between
                                                                        10-12PM</option>
                                                                    <option value="1382">Jopling House Communal
                                                                        Rooms</option>
                                                                    <option value="1412">Mental Wellbeing &amp;
                                                                        Counselling</option>
                                                                    <option value="1415">Order Building Materials
                                                                    </option>
                                                                    <option value="1416">Cleaning Stock List
                                                                    </option>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="" id="" class="form-control select2">
                                                                    <option value="" disable readonly selected>
                                                                        Salect an Option</option>
                                                                    <option value="1">Maintenance Ticket</option>
                                                                    <option value="2">General Enquiry Ticket
                                                                    </option>
                                                                </select>
                                                            </div>
                            ...
                            <button type="button" class="btn commonCancleButton">
                                ...
                                <iconify-icon icon="tabler:send"></iconify-icon> Send Quotation to Account
                                    ...
                                    <div class="tab-pane fade" id="AssignMaterial">
                                        <div class="fullwidthDesktopTabs MobileScrollShow innerUserContract_tabs">
                                                ...
                                                <ul
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Inventory Request</span>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Purchase Material
                                                                    Request</span>
                                                            </div>
                                                        </a>
                                                    </li>
                                        ...
                                        <div class="nicescroll-bar p-0">

                                            <!-- add new content here start -->
                                            <div class="post-list propertyTabContent">

                                                <div class="tab-content tabContent_hiddenStyle">
                                                    <div class="tab-pane fade show active" id="allinner_contract">
                                                        <div class="fullwidthTabInner_content_container">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                                                                                   ...
                                                                                                   data-bs-target="#assignMaterialEdit"
                                                                                                    ...
                                                                                                    <span
                                                                                                        class="icon"><span
                                                                                                            class="feather-icon"><iconify-icon icon="fluent:edit-16-regular">
                                                    ...
                                                    <div class="tab-pane fade" id="Addint_note_contaract">
                                                        <div class="fullwidthTabInner_content_container">
                                                            <div class="docFilterContainer">
                                                                <div class="docfilterbutton">
                                                                    <h2 class="tabinnerTitle">Inventory Request
                                                                    </h2>
                                                                    <div class="RightTabinr_container">
                                                    ...
                                                    <div class="tab-pane fade" id="ActivityLogs_usercontract">
                                                        <!-- <div class="docfilterbutton">
                                                        ...
                                                        <div class="collapse-simple">
                                                            <div class="card">
                                                                ...
                                                                <div id="" class="main_contractActiviti_container">
                                                                    <div class="col-lg-12">

                                                                        <div
                                                                            class="docfilterbutton completedrtask_headeract">
                                                                            <h2 class="tabinnerTitle">Purchase
                                                                                Material Request</h2>
                                                                            <div class="RightTabinr_container">
                                                                                <div
                                                                                    class="allSelect flex items-center gap-2 checkboxTask">
                                                                                    <input id="allSelectCheck"
                                                                                        class="" type="checkbox"
                                                                                        value="">
                                                                                    <label for="allSelectCheck"
                                                                                        class="align-middle">All
                                                                                        Select</label>
                                                                                </div>
                                                                                <div class="form-group">
                                                                            ...
                                                                            <div class="accordion-item">
                                                                                ...
                                                                                <div id="collapseOne"
                                                                                    ...
                                                                                    <div class="accordion-body">
                                                                                        <div
                                                                                            class="card card-border mb-lg-4 mb-3">
                                                                                            <div
                                                                                                class="card-header card-header-action">
                                                                ...
                                                                <div class="form-check customformchec_kInpdisabled">
                                                                    ...
                                                                    <label class="form-check-label" for="customCheckList6">
                                                                        ...
                                                                        <span class="done-strikethrough"></span>
                                                                                            ...
                                                                                            <div
                                                                                                class="card-body custombodyPadding">
                                                                                                <div
                                                                                                    class="d-flex text-center inspectionpropert_details">
                                                                                                    <div
                                                                                                        class="flex-1 border-end CustomFlex_style">
                                                                                                        <div
                                                                                                            class="ticInfo_Item">
                                                                                                            <span
                                                                                                                class="d-block TicketDetails_info_title">
                                                                                                                Supplier
                                                                                                                Name</span>
                                                                                                            <span
                                                                                                                class="d-block text-capitalize ticketdetailinfo_data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="" id="" class="form-control select2">
                                    <option disabled="" selected="" value="">Please Select...</option>
                                    <option value="Ac Motor">Stock Room</option>
...
<!-- Edit material modal -->
<div id="assignMaterialEdit" class="modal customwizard_formStyle sm_modalCustom fade" tabindex="-1" role="dialog"
aria-hidden="true">
<div class="modal-dialog modal-dialog-centered" role="document">
    <form action="" method="post" id="wizardForm">
        <div class="modal-content">
            ...
            <div class="ModalheaderArea">
                <h5 class="mb-4">Edit Material</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
        ...
        <div class="taskAppend">
            ...
            <div class="taskLHI">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="priceInput" class="form-label">Allocated Time (in min)</label>
