                        ...
                        <div class="d-flex align-items-center">
                            <div class="dropdown">
                                <a class="contactapp-title link-dark" href="#" role="button">
                                    <h1>Tenancy Cancellation Requests</h1>
                                </a>
                                ...
                                <div class="quick-access-form-wrap nopaddingleftright">
                                    <form class="quick-access-form border">
                                        <div class="row gx-3">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="form-label">End Tenancy Date</label>
                                                    <input class="form-control" type="text" name="daterange"
                                                        value="Pick a Date" />
                                                        <iconify-icon icon="ion:calendar-outline" class="dateinput_icon"></iconify-icon>
                                                </div>
                            ...
                            <div class="contact-list-view">
                                ...
                                <table class="table common-datatable nowrap w-100 ">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="view-tenant-details.php" class="namelinkURl">Morgan Freeman</a>
                                            </td>
                                            <td class="">
                                            ...
                                            <td>23/04/2023</td>
                                            <td>10/05/2023</td>
                                            <td> <span class="badge rounded-pill bg-outline-warning">Pending</span></td>
                                            <td>
                                            <div class="d-flex align-items-center ActionDropdown">
                                                    <div class="d-flex">
                                                        <a href="tenancy-cancel-detail.php"
                                        ...
                                        <tr>
                                            <td>
                                                <a href="view-tenant-details.php" class="namelinkURl">Jessica Alba</a>
                                            </td>
                                            <td class="">
                                                <a href="property-details.php">
                                                    <div class="LongMesage_container">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="view-tenant-details.php" class="namelinkURl">Chris Evans</a>
                                            </td>
                                            <td class="">
                                                <a href="property-details.php">
                                                    <div class="LongMesage_container">
                                            ...
                                            <td>01/02/2023</td>
                                            <td>14/03/2023</td>
                                            <td> <span class="badge rounded-pill bg-outline-success">Approved</span></td>
                                            <td>
                                            <div class="d-flex align-items-center ActionDropdown">
                                                    <div class="d-flex">
                                                        <a href="tenancy-cancel-detail.php"
                                        ...
                                        <tr>
                                            <td>
                                                <a href="view-tenant-details.php" class="namelinkURl">Emma Watson</a>
                                            </td>
                                            <td class="">
                                                <a href="property-details.php">
                                                    <div class="LongMesage_container">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="view-tenant-details.php" class="namelinkURl">Tom Hanks</a>
                                            </td>
                                            <td class="">
                                                <a href="property-details.php">
                                                    <div class="LongMesage_container">
                                            ...
                                            <td>05/06/2023</td>
                                            <td>15/07/2023</td>
                                            <td> <span class="badge rounded-pill bg-outline-danger">Rejected</span></td>
                                            <td>
                                            <div class="d-flex align-items-center ActionDropdown">
                                                    <div class="d-flex">
                                                        <a href="tenancy-cancel-detail.php"
                                        ...
                                        <tr>
                                            <td>
                                                <a href="view-tenant-details.php" class="namelinkURl">Scarlett
                                                    Johansson</a>
                                            </td>
                                            <td class="">
                                                <a href="property-details.php">
