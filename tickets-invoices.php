                            ...
                            <ul class="nav nav-tabs nav-line nav-icon fullwidthCustom_tabsUL nav-light">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#Details">
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text">Landlord Invoices</span>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#damagedeposites">
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text">Tenant Invoices</span>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#advancedpayment_invoices">
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text">Supplier Invoicing</span>
                        ...
                        <div class="nicescroll-bar">
                            ...
                            <div class="post-list propertyTabContent">
                                ...
                                <div class="tab-content">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center ActionDropdown">
                                                                    <div class="d-flex">
                                                                        <a href="landlord-invoice-details.php"
                                    ...
                                    <div class="tab-pane fade" id="advancedpayment_invoices">
                                        <div class="fullwidthTabInner_content_container">
                                            <div class="contact-list-view">
