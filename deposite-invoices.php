                        ...
                        <div class="contact-options-wrap">
                            ...
                            <div class="ActionBtn generate-invoice-btn" id="generateInvoiceBtn">
                                <button
                                    ...
                                    <iconify-icon icon="lucide:send"></iconify-icon> Approve Request
                                </button>
                                ...
                                <table class="table common-datatable nowrap w-100 ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>08/12/2024</td>
                                            <td>£229.69</td>
                                            <td class=""><span class="badge bg-success">Approved</span></td>
                                            <td>
                                                        ...
                                                        <!-- <a href="tenancy.php"
                                                            ...
                                                            data-bs-original-title="View Tenant Details"><span
                                                                class="icon"><span class="feather-icon"><svg
                                                                    ...
                                                                    <a href="##"
                                                            class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover voidBtn"
                                                            data-bs-toggle="tooltip" data-placement="top" title=""
                                                            data-bs-original-title="No need to generate invoice"><span
                                                                class="icon"><span class="feather-icon"><iconify-icon icon="tabler:ban"></iconify-icon></span></span>Void</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>08/12/2024</td>
                                            <td>£9.69</td>
                                            <td class=""><span class="badge bg-secondary">Approval Pending</span></td>
                                            <td>
                                                <div class="d-flex align-items-center ActionDropdown">
                                                    <div class="d-flex">
                                                    <a href="##"
