                    ...
                    <header class="contact-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div class=" ms-3">
                                ...
                                <a href="marketing-settings.php" class="btn btn-sm cmnbackbtn btn-outline-secondary ">
                                ...
                                <div class="ApplicationForm_wrapper">
                                    ...
                                    <div class="offcanvas-body">
                                        ...
                                        <div class="addingForm_Container ApplicationFrm_wrapper">
                                            <div class="add-users-modal-body-table-header text-headline-6"> Add New
                                                Application</div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="ApplicationformSection" id="section1">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label class="form-label">How Long You have
                                                                            lived in UK (for Non-British
                                                                            Citizens)</label>
                                                                        <select class="form-control select2">
                                                                            <option disabled selected value="">Please
                                                                                Select...</option>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        <label class="form-label">Do you have a
                                                                            Student/NUS Number?</label>
                                                                        <div class="flexoneselectgroup">
                                                                            <div class="form-check">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="NEOS"
                                                                                    id="neosopt1" value="neosopt1">
                                                                                <label class="form-check-label"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="pn-select" id="js_pn-select"
                                                                            ...
                                                                            <div class="pn-dropdown" id="js_dropdown">
                                                                                ...
                                                                                <!-- Country list -->
                                                                                <ul class="pn-list list" id="js_list">
                                                                                </ul>
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label class="form-label">Personal Email Address
                                                                            (Do not share University
                                                                            Email)</label>
                                                                        <input type="text" class="form-control"
                                                                            value="">
                                                                    </div>
                                                        ...
                                                        <div class="ApplicationformSection" id="section2">
                                                        ...
                                                        <div class="ApplicationformSection" id="section3">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select id="RentedOwnhouse_option"
                                                                                ...
                                                                                <option disabled selected value="">
                                                                                    Please
                                                                                    Select...</option>
                                                                                <option value="Rented Accommodation">
                                                                                    Rented
                                                                                    Accommodation</option>
                                                                                <option value="Parents House">Parents
                                                                                    House
                                                                                </option>
                                                                                <option value="Own House">Own House
                                                                                </option>
                                                                                <option value="Other">Other</option>
                                                                            </select>
                                                                        </div>
                                                        ...
                                                        <div class="ApplicationformSection" id="section4">
                                                            <div class="address_Fields_container"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Landlord
                                                                                Name</label>
                                                                            <input class="form-control" type="text"
                                                                                name="" value=""
                                                            ...
                                                            <div class="fields-container" data-section="section4"></div>
                                                        </div>

                                                        <div class="ApplicationformSection" id="section5">

                                                            <div class="customflexHeader">
                                                                <div class="tabinnerTitle">
                                                                    <iconify-icon icon="ri:user-settings-line">
                                                                    </iconify-icon>
                                                                    Home Address (for non-UK residents please provide
                                                        ...
                                                        <div class="fields-container" data-section="section5"></div>

                                                        </div>

                                                        <div class="ApplicationformSection" id="section6">
...
<div class="fields-container" data-section="section6"></div>
</div>



<div class="ApplicationformSection" id="section7">
...
<div class="fields-container" data-section="section7"></div>
</div>



<div class="ApplicationformSection" id="section8">
...
<div class="fields-container" data-section="section8"></div>
</div>
                                                        

                                                        
<div class="ApplicationformSection" id="section9">
...
<div class="address_Fields_container" id="GuranterBank_details"
    ...
    <div class="tabinnerTitle">
        <iconify-icon icon="ri:user-settings-line"></iconify-icon>
        Guarantor Bank Details (for credit check purposes
        only)
    </div>
    <button type="button"
        class="add-field-button-section add-field-button"
...
<div class="fields-container" data-section="section9"></div>
</div>

                                                        

<div class="ApplicationformSection" id="section10">
...
<div class="customflexHeader">
    ...
    <button type="button" class="add-field-button-section add-field-button" data-section-id="section10">
        <iconify-icon icon="si:add-fill">
        </iconify-icon> Add Field
    </button>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control select2">
                                                                            ...
                                                                            <option value="Existing Tenant">Existing
                                                                                Tenant</option>
                                                                            ...
                                                                            <option value="Accommodation For Students">
...
<div class="fields-container" data-section="section10"></div>
</div>     


<div class="ApplicationformSection" id="section11">
    <div class="customflexHeader">
        <div class="tabinnerTitle">
            <iconify-icon icon="ri:user-settings-line"></iconify-icon>
            GDPR Regulations
        </div>
        <button type="button" class="add-field-button-section add-field-button" data-section-id="section11">
            <iconify-icon icon="si:add-fill">
            </iconify-icon> Add Field
        </button>
    ...
    <div class="fields-container" data-section="section11"></div>
</div>



<div class="ApplicationformSection" id="section12">
    <div class="customflexHeader">
        <div class="tabinnerTitle">
            <iconify-icon icon="ri:user-settings-line"></iconify-icon>
            Application Submission
        </div>
        <button type="button" class="add-field-button-section add-field-button" data-section-id="section12">
            <iconify-icon icon="si:add-fill">
            </iconify-icon> Add Field
        </button>
    ...
    <div class="address_Fields_container">
                                                     ...
                                                     <!-- 7th step end -->
    <div class="fields-container" data-section="section12"></div>
</div>
