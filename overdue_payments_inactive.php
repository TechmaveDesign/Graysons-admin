...
<div class="container-xxl">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="dropdown">
                                <a class="contactapp-title link-dark" href="#" role="button">
                                    <h1>Overdue Payments Inactive</h1>
                                </a>
                    ...
                    <div class="contact-body">
                        <div class="nicescroll-bar">
                            <div class="userFilters onerowfilter" id="filterDiv" style="display: none;">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control customdataPicker flatpickr-input" placeholder="DD/MM/YYYY" value="" type="text" readonly="readonly">
                                                                </div>
                                                            </div>

                                                            <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="" class="form-label">Minimum Total</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="" class="form-label">Minimum Overdue Payments</label>
                                ...
                                <div class="col-lg-2">
                                                                <div class="form-group">
                                                                    <label class="form-label">Last Contacted Before</label>
                                                                    <input class="form-control customdataPicker flatpickr-input" placeholder="Select Date" value="" type="text" readonly="readonly">
                                                                </div>
                                                            </div>
                                ...
                                <table class="table common-datatable nowrap w-100 ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>23/04/2023</td>
                                            <td>2</td>
                                            <td> <span class="badge badge-soft-success amounttableBadge  my-1  me-2">£240.34</span></td>
                                            <td>15/06/2024</td>
                                            <td>
                                        ...
                                        <tr>
    <td>
        <a href="view-user-details.php" class="namelinkURl">Denzel Washington</a>
    </td>
    <td class="">
        <a href="property-details.php">
            <div class="LongMesage_container">
    ...
    <td>05/11/2022</td>
    <td>3</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£310.50</span></td>
    <td>20/08/2024</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
...
<tr>
    ...
    <td>14/02/2023</td>
    <td>1</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£150.75</span></td>
    <td>11/07/2024</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
...
<tr>
    ...
    <td>30/06/2023</td>
    <td>4</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£425.00</span></td>
    <td>22/09/2024</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
...
<tr>
    ...
    <td>10/01/2023</td>
    <td>2</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£375.25</span></td>
    <td>05/12/2024</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
...
<tr>
    ...
    <td>15/03/2023</td>
    <td>5</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£500.00</span></td>
    <td>12/01/2025</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
...
<tr>
    ...
    <td>28/05/2023</td>
    <td>2</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£350.60</span></td>
    <td>18/03/2025</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
...
<tr>
    ...
    <td>01/07/2023</td>
    <td>3</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£420.80</span></td>
    <td>23/10/2024</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
...
<tr>
    <td>
        <a href="view-user-details.php" class="namelinkURl">Robert Downey Jr.</a>
    </td>
    <td class="">
        <a href="property-details.php">
            <div class="LongMesage_container">
    ...
    <td>19/09/2023</td>
    <td>4</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£485.00</span></td>
    <td>15/05/2025</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
...
<tr>
    ...
    <td>22/08/2023</td>
    <td>1</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£275.45</span></td>
    <td>28/11/2024</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
...
<tr>
    ...
    <td>10/11/2023</td>
    <td>2</td>
    <td> <span class="badge badge-soft-success amounttableBadge my-1 me-2">£365.90</span></td>
    <td>07/04/2025</td>
    <td>
        <div class="d-flex align-items-center ActionDropdown">
            <div class="d-flex">
