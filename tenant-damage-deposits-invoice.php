                        ...
                        <div class="d-flex align-items-center">
                            <div class="dropdown">
                                <a class="contactapp-title link-dark" href="##" role="button">
                                    <h1>Damage Deposite Invoice Details </h1>
                                </a>

                            </div>
                            <div class=" ms-3">
                                <a href="tenant-damage-deposits.php"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm">
                                                            <form class="form-inline p-3 bg-grey-light-5 rounded">
                                                                <div class="invoiceFlex_header gx-3 ">
                                                                    <div class="col-xl-auto mb-xl-0 mb-2">
                                                                        <label class="form-label mb-xl-0">Deposit
                                                                            :</label>
                                                                    </div>
                                                                    <div class="col-xl-auto mb-xl-0 mb-2 depositeamount_col">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        type="button" >
                                                                        <iconify-icon icon="fluent:branch-request-20-regular"></iconify-icon> request
                                                                        additional deposit
                                                                    </button>
