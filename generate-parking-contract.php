...
<div class="container-xxl">
    ...
    <div class="hk-pg-body py-0">
        <form action="generate-parking-contract.php">
                    ...
                    <ul class="nav nav-tabs nav-line nav-icon fullwidthCustom_tabsUL nav-light">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#tab_boards">
                                <span class="nav-link-text">Generate Contract</span>
                            </a>
                        </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab_boards">
                                    <div class="contractfullpageform_container">
                                        <div class="add-users-modal-body-table-header text-headline-6"> Parking Tenancy
                                            Details</div>
                                        ...
                                        <div class="formstartcontainer">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="Title"
                                                            value="Dean Shaw" readonly disabled>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="" id="" class="form-control select2">
                                                            ...
                                                            <option value="15" selected>Communal Area Inspection House
                                                                16</option>
                                                            <option value="19">Communal Area Inspection House 22
                                                            </option>
                                                ...
                                                <div class="col-auto">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input guranterCheckbox"
                                            ...
                                            <div class="Guarantor_Container idrequiredChecked">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="" class="form-label"> Guarantor Contact
                                                                Number</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="addressline1" class="form-label">Guarantor
                                                                Address Line
                                                                1</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="addressline2" class="form-label"> Guarantor
                                                                Address Line
                                                                2</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="Town/City" class="form-label">Guarantor
                                                                Town/City</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="County" class="form-label">Guarantor
                                                                County</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="Postcode" class="form-label">Guarantor
                                                                Postcode</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="preview_doc_container">
                                                                    <img src="dist/img/newimages/preview-doc.png"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="contractSubmit_container">
                                                                    <button id="sendBtn" type="button"
                                                                        ...
                                                                        data-bs-target="#previewcontract">
                                                                        <img src="dist/img/newimages/sendicon.png"
                                                                            alt="">
                                                                        Preview Contract
                                                                    </button>
                                                                </div>
...
<div id="previewcontract" class="modal customwizard_formStyle sm_modalCustom fade" tabindex="-1" role="dialog"
    aria-hidden="true">
                        ...
                        <div class="invoice-container">
                                ...
                                <header class="car-header-img" id="invo_header">
                                    <div class="invoice-logo-content invoice-logo-content-car ">
                                        <div class="invoice-logo width-70">
                                            <a href="car_booking.html" class="logo-car"><img
                                                    src="dist/img/newimages/logo-dark.png"
                                ...
                                <section class="agency-service-content car-invoice-content" id="car_booking">
                                    <div class="container">
                                        ...
                                        <div class="money-send-title-wrap hire-mt pt-40">
                                            ...
                                            <div class="mon-sent-content-wrap">
                                                <div class="mon-send-left-data">
                                                    ...
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Contract Start
                                                            Date:</span>
                                                ...
                                                <div class="mon-send-right-data">
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Agreement
                                                            Date:</span>
                                                        <span class="font-sm">10, july 2024</span>
                                                    </div>
                                        ...
                                        <div class="money-send-title-wrap pt-40">
                                            <h3 class="font-lg color-dark-yellow transfer-title ">Property Information
                                            </h3>
                                            <div class="mon-sent-content-wrap">
                                                <div class="mon-send-left-data">
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Property
                                                            Address:</span>
                                                        <span class="font-sm">1-7 Union Street</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">landlord Name
                                                            :</span>
                                                ...
                                                <div class="mon-send-left-data">
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Property Type
                                                            :</span>
                                                        <span class="font-sm">Apartment</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">landlord Address
                                                            :</span>
                                                        <span class="font-sm">1-7 Union Street</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mon-send-right-data">
                                                <div class="mon-send-col-two">
                                                    <span class="font-sm-500 color-light-black">Property
                                                        Information:</span>
                                                    <span class="font-sm">Lorem ipsum, dolor sit amet consectetur
                                                        adipisicing elit. Mollitia, saepe?</span>
                                                </div>
                                            </div>

                                            <div class="mon-send-right-data">
                                                <div class="mon-send-col-two">
                                                    <span class="font-sm-500 color-light-black">Property Utility
                                                        Information:</span>
                                                    <span class="font-sm">Lorem ipsum, dolor sit amet consectetur
                                                        adipisicing elit. Mollitia, saepe?</span>
                                                </div>
                                        ...
                                        <div class="money-send-title-wrap pt-40">
                                            <h3 class="font-lg color-dark-yellow transfer-title ">Payment Information
                                            </h3>
                                            <div class="mon-sent-content-wrap">
                                                <div class="mon-send-left-data">
                                                    <div class="mon-send-col-one">
                                                    ...
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Utility ( per week )
                                                            :</span>
                                                        <span class="font-sm">C120</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Installments
                                                            :</span>
                                                        <span class="font-sm">5</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Rent Total (Full
                                                            Term) :</span>
                                                        <span class="font-sm">1</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Utility Total (Full
                                                            Term) :</span>
                                                        <span class="font-sm">0</span>
                                                    </div>

                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">First Payment Date
                                                            :</span>
                                                        <span class="font-sm">10, july 2024</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Payments Dates
                                                            :</span>
                                                ...
                                                <div class="mon-send-left-data">
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Rent ( per week )
                                                            :</span>
                                                    ...
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Installment
                                                            Remaining After First Payment :</span>
                                                        <span class="font-sm">1</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Rental Payments
                                                            :</span>
                                                        <span class="font-sm">0</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Utility Payments
                                                            :</span>
                                                        <span class="font-sm">0</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Payment Reference
                                                            Number :</span>
                                                        <span class="font-sm">654567656</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Starting From
                                                            :</span>
                                        ...
                                        <div class="money-send-title-wrap pt-40">
                                            <h3 class="font-lg color-dark-yellow transfer-title ">Tenant Information
                                            </h3>
                                            <div class="mon-sent-content-wrap">
                                                <div class="mon-send-left-data">
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Tenant Full
                                                            Name:</span>
                                                        <span class="font-sm">Danial Craig</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Tenant Address
                                                            :</span>
                                                        <span class="font-sm">Lorem ipsum dolor sit amet
                                                            consectetur.</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Tenant Student No
                                                            :</span>
                                                        <span class="font-sm">#ST456</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Tenant Number
                                                            :</span>
                                                ...
                                                <div class="mon-send-left-data">
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Tenant Email Address
                                                            :</span>
                                                    ...
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Tenant University
                                                            and Course :</span>
                                        ...
                                        <div class="money-send-title-wrap pt-40">
                                            <h3 class="font-lg color-dark-yellow transfer-title ">Gurantor Information
                                            </h3>
                                            <div class="mon-sent-content-wrap">
                                                <div class="mon-send-left-data">
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Gurantor Full
                                                            Name:</span>
                                                        <span class="font-sm">Danial Craig</span>
                                                    </div>
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Gurantor Address
                                                            :</span>
                                                        <span class="font-sm">Lorem ipsum dolor sit amet
                                                            consectetur.</span>
                                                    </div>
                                                ...
                                                <div class="mon-send-left-data">
                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Gurantor Email
                                                            Address :</span>
                                                        <span class="font-sm">danialc@jampack.com</span>
                                                    </div>

                                                    <div class="mon-send-col-one">
                                                        <span class="font-sm-500 color-light-black">Gurantor Number
                                                            :</span>
                            ...
                            <section class="agency-bottom-content d-print-none" id="agency_bottom">
                                ...
                                <div class="invo-note-wrap">
                                        ...
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_8_240)">
                                                ...
                                                <path
                                                    ...
                                                    stroke="#12151C" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M9 7H10" stroke="#12151C" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M9 13H15" stroke="#12151C" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M13 17H15" stroke="#12151C" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                            </g>
                                            <defs>
                                    ...
                                    <h3 class="font-md-grey color-grey note-desc">This is computer generated receipt and
                                        does not require physical signature.</h3>
                                </div>
                                <!--Note content end -->
                            </section>
