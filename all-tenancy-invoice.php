                    ...
                    <div class="contact-body">
                            ...
                            <ul class="nav SubTabInvoice nav-tabs nav-line nav-icon fullwidthCustom_tabsUL nav-light">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#landlordinv">
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text">Rent Invoice</span>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#TenantInv">
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text">Utility Invoice</span>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#supplierInv">
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text">Ticket Invoice</span>

                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#damageInv">
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text">Damage Invoice</span>
                        ...
                        <div class="nicescroll-bar">
                            ...
                            <div class="tab-content">
                                                        ...
                                                        <div class="d-flex align-items-center ActionDropdown">
                                                            <div class="d-flex">
                                                                ...
                                                                <a href="view-ticket.php"
                                                                    ...
                                                                    title=""
                                                                    data-bs-original-title="View Ticket Details"><span
                                ...
                                <div class="tab-pane fade" id="damageInv">
                                    <div class="fullwidthTabInner_content_container">
                                    <div class="contact-list-view">
                                        ...
                                        <table class="table common-datatable nowrap w-100 ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>TV is not working show the lines on screen</td>
                                                    <td>12 Dec, 2024</td>
                                                    <td>
                                                        <div class="LongMesage_container"
                                                            style="position: relative;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input row-checkbox" type="checkbox" id="gridCheck2">
                                                    ...
                                                    <td>
                                                        <div class="LongMesage_container" style="position: relative;">
                                                            <input
                                                                class="refuge-collection-input tableLongMessage_Input"
                                                                value="Kitchen, Flat 10 (Floor 5, No10), Riverfront Towers">
                                                    ...
                                                    <td>
                                                        <a href="view-user-details.php">
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body">
                                                                    <span class="d-block text-high-em">Tom Hanks</span>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center ActionDropdown">
                                                            <div class="d-flex">
                                                                <a href="view-ticket.php" class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="View Ticket Details">
                                                                    <span class="icon"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye">
                                                                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                                                        <circle cx="12" cy="12" r="3"></circle>
                                                                    </svg></span></span>
                                                                </a>
                                                                <div class="voidBox">
                                                                    <a href="#" class="voidBtn" data-bs-toggle="tooltip" data-bs-placement="top" title="No need to generate invoice">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Bathroom washbasin break</td>
                                                    <td>16Dec, 2024</td>
                                                    <td>
                                                        <div class="LongMesage_container" style="position: relative;">
                                                            <input
