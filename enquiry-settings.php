                                ...
                                <div class="post-list propertyTabContent">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="Single_Individual">
                                            <div class="fullwidthTabInner_content_container" id="section1">
                                                <form class="" action="all-Enquiries.php" method="POST">
                                                    <div class="customflexHeader">
                                                        <div class="tabinnerTitle">
                                                            ...
                                                            Enquiry Settings For Single Individual
                                                        </div>
                                                        <button type="button"
                                                            class="add-field-button-section add-field-button"
                                                            data-section-id="section1">
                                                            <iconify-icon icon="si:add-fill">
                                                            </iconify-icon> Add Field
                                                        </button>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Are you a student
                                                                                , Family or a young
                                                                                professional?</label>
                                                                            <div
                                                                                class="flexoneselectgroup selectioncontainer">
                                                                    ...
                                                                    <div class="col-lg-6 Guarantorselect_column">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Do you have UK
                                                                                Home Owner Guarantor?</label>
                                                                            <div class="flexoneselectgroup">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="radio" name="professional"
                                                                                        id="gridRadiosp1"
                                                                                        value="gridRadiosp1">
                                                                                    <label class="form-check-label"
                                                                                        for="gridRadiosp1">
                                                                    ...
                                                                    <div class="col-md-6 locationselect_colcontainer"
                                                                        style="display: none;">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Which University
                                                                                you are attending or going to
                                                                                attend?</label>
                                                                            <select class="form-control select2"
                                                                                id="universitySelect">
                                                                                <option disabled selected value="">
                                                                                ...
                                                                                <option value="Northumbria">Northumbria
                                                                                </option>
                                                                        ...
                                                                        <div class="form-group"
                                                                            id="otherUniversityInput"
                                                                            style="display: none;">
                                                                            <label class="form-label">Please
                                                                                specify:</label>
                                                                            <input type="text" class="form-control"
                                                                                id="otherUniversityText">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select id=""
                                                                                class="form-control nationality-select select2">
                                                                                <option disabled selected value="">
                                                                                    Please Select...</option>
                                                                            </select>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Preferred date to
                                                                                start your tenancy</label>
                                                                            <input
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group">
                                                                            <label class="form-label">The period of
                                                                                weeks you are looking to rent?</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Your current
                                                                                weekly rental budget?</label>
                                                                            <select class="form-control select2">
                                                                                <option disabled selected value="">
                                                                                    Please Select...</option>
                                                                                <option value="£ 90.00 - £ 100.00">£
                                                                                    90.00 - £ 100.00</option>
                                                                                <option value="£ 101.00 - £ 120.00">£
                                                                                    101.00 - £ 120.00</option>
                                                                                <option value="£ 121.00 - £ 140.00">£
                                                                                    121.00 - £ 140.00</option>
                                                                                <option value="£ 141.00 - £ 160.00">£
                                                                                    141.00 - £ 160.00</option>
                                                                                <option value="£ 161.00 - £ 180.00">£
                                                                                    161.00 - £ 180.00</option>
                                                                                <option value="£ 181.00 - £ 200.00">£
                                                                                    181.00 - £ 200.00</option>
                                                                                <option value="£ 201.00 and above">£
                                                                                    201.00 and above</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Are you looking
                                                                                for bills inclusive or bills exclusive?
                                                                            </label>
                                                                            <select class="form-control select2">
                                                                                <option disabled selected value="">
                                                                                    Please Select...</option>
                                                                                <option value="Bills Inclusive">Bills
                                                                                    Inclusive</option>
                                                                                <option value="Bills Exclusive">Bills
                                                                                    Exclusive</option>
                                                                                <option value="Bills Exclusive">Explore
                                                                                    both options</option>
                                                                            </select>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Are you a night or
                                                                                a day person?</label>
                                                                            <select class="form-control select2">
                                                                                <option disabled selected value="">
                                                                                    Please Select...</option>
                                                                                <option value="Night Person">Night
                                                                                    Person</option>
                                                                                <option value="Day Person">Day Person
                                                                                </option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="form-control select2">
                                                                                <option disabled selected value="">
                                                                                    Please Select...</option>
                                                                                <option value="11">Enquiry Received
                                                                                </option>
                                                                                <option value="12">Information Requested
                                                                                </option>
                                                                                <option value="13">Information Sent
                                                                                </option>
                                                                                <option value="14">Viewings Requested
                                                                                </option>
                                                                                <option value="15">Viewings Booked
                                                                                </option>
                                                                                <option value="16">Awaiting Viewing
                                                                                    Feedback</option>
                                                                                <option value="17">Viewing Cancelled
                                                                                </option>
                                                                                <option value="18">Viewing FTA</option>
                                                                                <option value="19">First Follow-up Sent
                                                                                </option>
                                                                                <option value="20">Second Follow-up Sent
                                                                                </option>
                                                                                <option value="21">Final Follow-up Sent
                                                                                </option>
                                                                                <option value="22">Tenant Applied
                                                                                </option>
                                                                                <option value="23">Application Processed
                                                                                </option>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div
                                                                            class="form-group propertyMultiselect_container">
                                                                            <label class="form-label">Properties</label>
                                                                            <select class="form-control select2"
                                                                                multiple="multiple">
                                                                                <option disabled value="">Please
                                                                                    Select...</option>
                                                                                <option value="1">Communal Area
                                                                                    Inspection House 10</option>
                                                                                <option value="2">Communal Area
                                                                                    Inspection House 14</option>
                                                                                <option value="3">Communal Area
                                                                                    Inspection House 16</option>
                                                                                <option value="4">Communal Area
                                                                                    Inspection House 18</option>
                                                                                <option value="5">Communal Area
                                                                                    Inspection House 2</option>
                                                                                <option value="6">Communal Area
                                                                                    Inspection House 21</option>
                                                                                <option value="7">Communal Area
                                                                                    Inspection House 22</option>
                                                                                <option value="8">Communal Area
                                                                                    Inspection House 23</option>
                                                                                <option value="9">Communal Area
                                                                                    Inspection House 24</option>
                                                                                <option value="10">Communal Area
                                                                                    Inspection House 25</option>
                                                                                <option value="11">Communal Area
                                                                                    Inspection House 26</option>
                                                                                <option value="12">Communal Area
                                                                                    Inspection House 27</option>
                                                                                <option value="13">Communal Area
                                                                                    Inspection House 28</option>
                                                                                <option value="14">Communal Area
                                                                                    Inspection House 29</option>
                                                                                <option value="15">Communal Area
                                                                                    Inspection House 3</option>
                                                                                <option value="16">Communal Area
                                                                                    Inspection House 49</option>
                                                                                <option value="17">Communal Area
                                                                                    Inspection House 52</option>
                                                                                <option value="18">Communal Area
                                                                                    Inspection House 53</option>
                                                                                <option value="19">Communal Area
                                                                                    Inspection House 55</option>
                                                                                <option value="20">Communal Area
                                                                                    Inspection House 58</option>
                                                                                <option value="21">Communal Area
                                                                                    Inspection House 6</option>
                                                                                <option value="22">Communal Area
                                                                                    Inspection House 8</option>
                                                                            </select>
                                                                        </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <select class="form-control select2"
                                                                                ...
                                                                                <option disabled value="">Please
                                                                                    Select...</option>
                                                                                <option
                                                                                    value="15 Stepney Lane, Newcastle upon Tyne">
                                                                                    15 Stepney Lane,
                                                                                ...
                                                                                <option
                                                                                    value="Stocksfield, Northumerland">
                                                                                    Stocksfield, Northumerland
                                                                                </option>
                                                                                <option
                                                                                    value="Brunswick Industrial Estate, Wideopen">
                                                                                ...
                                                                                <option value="Newcastle Upon Tyne">
                                                                                    Newcastle Upon Tyne</option>
                                                                                <option value="West One">West One
                                                                                </option>
                                                                                <option value="Newcastle upon tyne">
                                                                                    Newcastle upon tyne</option>
                                                                                <option
                                                                                    value="11-13 Stepney Lane, Newcastle upon Tyne">
                                                                                    11-13 Stepney Lane,
                                                                                    Newcastle upon Tyne</option>
                                                                                <option
                                                                                    value="5-9 Stepney Lane, Newcastle upon Tyne">
                                                                                    5-9 Stepney Lane,
                                                                                    Newcastle upon Tyne</option>
                                                                                <option value="sector 63">sector 63
                                                                                </option>
                                                                                <option value="Durham">Durham</option>
                                                                                <option value="Gateshead">Gateshead
                                                                                </option>
                                                                                ...
                                                                                <option
                                                                                    ...
                                                                                    5-9 stepney lane,
                                                                                    newcastle upon tyne</option>
                                                                                <option value="Bedlington">Bedlington
                                                                                </option>
                                                                                <option value="Lanchester">Lanchester
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Apartment
                                                                                Type</label>
                                                                            <select class="form-control select2">
                                                                                <option disabled selected value="">
                                                                                    Please Select...</option>
                                                                                <option value="1 Bed Apartment">1 Bed
                                                                                    Apartment</option>
                                                                                <option value="2 Bed Apartment">2 Bed
                                                                                    Apartment</option>
                                                                                <option value="3 Bed Apartment">3 Bed
                                                                                    Apartment</option>
                                                                                <option value="4 Bed Apartment">4 Bed
                                                                                    Apartment</option>
                                                                                <option value="5 Bed Apartment">5 Bed
                                                                                    Apartment</option>
                                                                                <option value="6 Bed Apartment">6 Bed
                                                                                    Apartment</option>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Preferred method
                                                                                of contact:</label>
                                                                            <div class="row">
                                                                                <div class="col-auto">
                                                                                    <div
                                                                                        ...
                                                                                        <input type="checkbox"
                                                                                            ...
                                                                                            id="customChecks1">
                                                                                        <label class="form-check-label"
                                                                                            for="customChecks1">Email
                                                                                            (you may
                                                                                            need to check your spam/junk
                                                                                            folder)</label>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-auto">
                                                                                ...
                                                                                <div class="col-auto">
                                                                                    <div
                                                                                        ...
                                                                                        <input type="checkbox"
                                                                                            ...
                                                                                            id="customChecks5">
                                                                                        <label class="form-check-label"
                                                                                            for="customChecks4">WhatsApp</label>
                                                                                    </div>
                                                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="Dual_Occupancy">
                                            <div class="fullwidthTabInner_content_container" id="section2">
                                                <form class="" action="all-Enquiries.php" method="POST">

                                                    <div class="customflexHeader">
                                                        <div class="tabinnerTitle">
                                                            <iconify-icon icon="ri:user-settings-line"></iconify-icon>
                                                            Enquiry Settings For Dual Occupancy
                                                        </div>
                                                        <button type="button"
                                                            class="add-field-button add-field-button-section "
                                                    ...
                                                    <div class="formstartcontainer">
                                                        ...
                                                        <div class="fields-container" data-section="section2"></div>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="GroupEnquiry">
                                            <div class="fullwidthTabInner_content_container" id="section3">
                                                <form class="" action="all-Enquiries.php" method="POST">
                                                    <div class="customflexHeader">
                                                        <div class="tabinnerTitle">
                                                            <iconify-icon icon="ri:user-settings-line"></iconify-icon>
                                                            Enquiry Settings For Group
                                                        </div>
                                                        <button type="button"
                                                            class="add-field-button add-field-button-section "
                                                    ...
                                                    <div class="formstartcontainer">
                                                        ...
                                                        <div class="fields-container" data-section="section3"></div>
                                                    </div>
                                                ...
                                                <div class="docfilterbutton">
                                                    ...
                                                    <div class="RightTabinr_container">
                                                        ...
                                                        <button
                                                            ...
                                                            data-bs-target="#add_enquiry_status">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <button type="button"
                                                                                        ...
                                                                                        data-bs-target="#View_enquiry_status"><span
                                                                                            class="icon"><span
                                                                                                class="feather-icon">
                                                                                                <iconify-icon
                                                ...
                                                <div class="docfilterbutton">
                                                    ...
                                                    <div class="RightTabinr_container">
                                                        ...
                                                        <button
                                                            class="btn btn-sm addiconiButton commonAddnewButton btn-primary ms-3"
                                                            type="button" data-bs-toggle="modal"
                                                            data-bs-target="#add_enquiry_source">
                                                            <iconify-icon icon="lets-icons:add-round">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <button type="button"
                                                                                        ...
                                                                                        type="button"
                                                                                        data-bs-toggle="modal"
                                                                                        data-bs-target="#View_enquiry_source"><span
                                                                                            class="icon"><span
                                                                                                class="feather-icon">
                                                                                                <iconify-icon
                                                                                                    icon="teenyicons:eye-outline">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="d-flex">
                                                                                    <a href="view-ticket.php"
                                                                                        class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover "
                                                                                        data-bs-toggle="modal"
                                                                                        data-bs-target="#View_enquiry_source"
                                                                                        type="button"><span
                                                                                            class="icon"><span
                                                                                                class="feather-icon">
                                                                                                <iconify-icon
...
<div class="modal fade" id="addFieldModal" tabindex="-1" aria-labelledby="addFieldModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="ModalheaderArea">
                <h5 class="" id="addFieldModalLabel">Add/Edit Field</h5>
            ...
            <form id="fieldForm">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2" id="fieldType">
                            <option value="Select an Option to add">Select an Option to add</option>
                    ...
                    <div id="fieldOptionsContainer" class="mb-3" style="display: none;">
                        <div class="d-flex align-items-center mb-2" id="fieldLabelContainer">
                            <span class="form-label label-text" data-field-type="select">Select Field</span>
                            <iconify-icon icon="ph:pencil-simple-line" class="edit-icon ms-2" style="cursor: pointer;">
                            </iconify-icon>
                        </div>
                        <div id="optionsList"></div>
                        <input type="text" class="form-control mb-2" id="newOption" placeholder="Enter option text">
                        <button type="button" class="btnComn_add_lightbg" id="addOption">
                            <iconify-icon icon="octicon:feed-plus-16"></iconify-icon> Add Option
                        </button>
                        <input type="text" class="form-control editable mt-2" id="selectLabelEditable"
                            style="display: none;">
                    </div>

                    <div id="inputFieldsContainer" class="mb-3" style="display: none;">
                        <label class="form-label">Input Fields:</label>
                        <div id="inputList"></div>
                        <button type="button" class="btnComn_add_lightbg" id="addInput">
                            <iconify-icon icon="octicon:feed-plus-16"></iconify-icon> Add Input
                        </button>
                    </div>

                    <div id="dateFieldsContainer" class="mb-3" style="display: none;">
                        <div class="d-flex align-items-center mb-2">
                            <span class="form-label label-text" data-field-type="date">Date Field</span>
                            <iconify-icon icon="ph:pencil-simple-line" class="edit-icon ms-2" style="cursor: pointer;">
                            </iconify-icon>
                        </div>
                        <input type="text" class="form-control customdataPicker flatpickr-input" id="newDate"
                            placeholder="Select Date" readonly="readonly">
                        <input type="text" class="form-control editable mt-2" id="dateLabelEditable"
                            style="display: none;">
                    </div>

                    <div id="multiselectFieldsContainer" class="mb-3" style="display: none;">
                        <div class="d-flex align-items-center mb-2">
                            <span class="form-label label-text" data-field-type="multiselect">MultiSelect Field</span>
                            <iconify-icon icon="ph:pencil-simple-line" class="edit-icon ms-2" style="cursor: pointer;">
                            </iconify-icon>
                        </div>
                        <div id="multiselectOptionsList"></div>
                        <input type="text" class="form-control mb-2" id="newMultiselectOption"
                            placeholder="Enter option text">
                        <button type="button" class="btnComn_add_lightbg" id="addMultiselectOption">
                            <iconify-icon icon="octicon:feed-plus-16"></iconify-icon> Add Option
                        </button>
                        <input type="text" class="form-control editable mt-2" id="multiselectLabelEditable"
                            style="display: none;">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="addfieldmodal_submit commonCanvas_buttonFooter">Save Field</button>
                </div>
            </form>
        </div>
    </div>
