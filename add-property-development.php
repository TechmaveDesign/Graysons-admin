                    ...
                    <header class="contact-header">
                        ...
                        <div class="contact-options-wrap">
                            <button id="Addproperty_development"
                                class="btn btn-sm addiconiButton commonAddnewButton btn-primary ms-3 ScheduleAddBtnfor_property"
                                type="button" data-bs-toggle="modal" data-bs-target="#Addproperty__modal">
                                <iconify-icon icon="lets-icons:add-round"></iconify-icon> Add New Development
                            </button>
                                    ...
                                    <div class="fullwidthTabInner_content_container">
                                        ...
                                        <ul class="nav nav-tabs nav-line nav-icon autoloadTabs fullwidthCustom_tabsUL nav-light"
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="property1-tab" data-bs-toggle="tab"
                                                    data-bs-target="#property1" type="button" role="tab"
                                                    aria-controls="property1" aria-selected="true">
                                            ...
                                            <div class="tab-pane fade show active" id="property1" role="tabpanel"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                                            <div class="row">
                                                                                ...
                                                                                <div
                                                                                    class="col-md-3 newPropertyTypeDiv">
                                                                                    <div class="form-group">
                                                                                        <label class="form-label">Add
                                                                                            New Property Type</label>
                                                                                        <div
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div id="FloorInrTabs">
                                                            <!-- Floor Tabs -->
                                                            <ul class="nav nav-pills custom-floor-tabs" id="floorTab"
                                                                role="tablist">
                                                                <li class="nav-item" role="presentation">
                                                                    <button class="nav-link active" id="gfloor-tab"
                                                                        data-bs-toggle="pill" data-bs-target="#gfloor"
                                                                        type="button" role="tab" aria-controls="gfloor"
                                                                        aria-selected="true">
                                                        ...
                                                        <div class="tab-content mt-3" id="floorTabContent">
                                                            <div class="tab-pane fade show active" id="gfloor"
                                                                ...
                                                                <div class="SubuNitAddContainer" id="unitContainer1">
                                                            ...
                                                            <div class="tab-pane fade" id="firstfloor" role="tabpanel"
                                                                aria-labelledby="firstfloor-tab">
                                                                <div class="SubuNitAddContainer" id="unitContainer2">
                                                                    <div class="container mt-5">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                            ...
                                                            <div class="tab-pane fade" id="secondfloor" role="tabpanel"
                                                                aria-labelledby="secondfloor-tab">
                                                                <div class="SubuNitAddContainer" id="unitContainer3">
                                                                    <div class="container mt-5">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
...
<div id="Addproperty__modal" class="modal customwizard_formStyle sm_modalCustom fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form action="add-property-development.php" method="post" id="addpropertyModal">
...
<div id="floorAdd__modal" class="modal customwizard_formStyle sm_modalCustom fade" tabindex="-1" role="dialog"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form action="" method="" id="addpropertyModal2">
            <div class="modal-content">
    ...
    document.getElementById('floorctrate_button').addEventListener('click', function() {
        ...
        if (floorCount && !isNaN(floorCount) && Number(floorCount) > 0) {
            Swal.fire({
                ...
                willClose: () => {
                    window.location.href = 'add-property-development.php';
                }
            });
        } else {
            Swal.fire({
