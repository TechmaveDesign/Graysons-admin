...
window.smoothScroll = function (window, document, undefined) {
  ...
  var _getEndLocation = function _getEndLocation(anchor, headerHeight, offset) {
    var location = 0;
  ...
  var animateScroll = function animateScroll(toggle, anchor, options, event) {
    ...
    var updateURL = overrides.updateURL || options.updateURL; // Selectors and variables
    ...
    var timeLapsed = 0;
    var percentage, position; // Prevent default click event
    ...
    _updateURL(anchor, updateURL); // Stop the scroll animation when it reaches its target (or the bottom/top of page)
    // Private method
    // Runs functions
