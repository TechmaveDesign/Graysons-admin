...
$(document).on("click", ".btn-add-tasklist", function (e) {
  ...
  if ($('.add-tasklist-modal input.form-control').val()) taskListName = $('.add-tasklist-modal input.form-control').val();else taskListName = "All Modules";
