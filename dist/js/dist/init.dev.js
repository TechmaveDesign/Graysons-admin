...
var toggleFullscreen = function toggleFullscreen(elem) {
...
var jampack = function jampack() {
  ...
  $(document).on('click', '[data-layout="twocolumn"] .main-menu .menu-content-wrap .nav-link', function (e) {
    if ($(this).attr("data-target")) {
      ...
      if ($wrapper.attr('data-submenu') == 'active' && $(id).hasClass("d-flex")) $wrapper.removeAttr('data-submenu');else {
...
var horizontalMenu = function horizontalMenu() {
...
var navheadMenu = function navheadMenu() {
...
var contactApp = function contactApp() {
...
var invoiceApp = function invoiceApp() {
...
var galleryApp = function galleryApp() {
...
var integrationsApp = function integrationsApp() {
...
var taskboardApp = function taskboardApp() {
...
var checklistApp = function checklistApp() {
  var id;
...
$(window).on("resize", function () {
  ...
  if (width > 1199 && $wrapper.attr('data-layout-style') == 'offcanvas' && $wrapper.attr('data-layout') == 'twocolumn') $wrapper.removeAttr('data-layout-style');
  if (width <= 1199 && $wrapper.attr('data-layout') == 'twocolumn' && $wrapper.attr('data-submenu') == 'active' || width > 1199 && $wrapper.attr('data-submenu') == 'active') $wrapper.removeAttr('data-submenu');
  /*Chat App Resopnsive*/
