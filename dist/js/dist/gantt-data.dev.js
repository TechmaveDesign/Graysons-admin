...
$(function () {
  ...
  var table_grp = $('#datable_1t').DataTable({
    ...
    "drawCallback": function drawCallback(settings) {
      ...
      api.column(groupColumn, {
        ...
        if (last !== group) {
          $(rows).eq(i).before('<tr class="group"><td class="row-sep" colspan="5">' + group + '</td></tr>');
          last = group;
        }
      });
    }
  ...
  Split(['#split_1', '#split_2'], {
    gutter: function gutter(index, direction) {
  ...
  var s = new Gantt("#gantt", [{
    ...
    padding: 18,
    view_mode: "Week",
    custom_popup_html: function custom_popup_html(e) {
