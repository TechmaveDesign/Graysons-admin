                                                    ...
                                                    <div class="applicationFrm_header">
                                                        ...
                                                        <div class="cntrt_detailright_header_action">
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                data-bs-toggle="modal" data-bs-target="#AddNote_modal">
                                                                <iconify-icon icon="fluent:note-add-24-regular">
                                                                </iconify-icon> Add Note
                                                            </button>

                                                            <button type="button"
                                                                class="previewNote_button rightactionbutton_cmnStyle"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#previewNotes_modal">
                                                    ...
                                                    <div class="formstartcontainer">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group editable-field"
                                                                            ...
                                                                            <div class="EditbleData_wrap">
                                                                                <div class="form-content">
                                                                                    <span class="form-text">05, November
                                                                                        2024
                                                                                    </span>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group editable-field"
                                                                            ...
                                                                            <div class="EditbleData_wrap">
                                                                                <div class="form-content">
                                                                                    <span
                                                                                        class="form-text">Brazilian</span>
                                                                                    <!-- Initially shows only selected option text -->
                                                                                    <select
                                                                                        class="form-control select2 d-none">
                                                                                        <option disabled value="">Please
                                                                                        ...
                                                                                        <option value="Central African">
                                                                                            Central
                                                                                            African</option>
                                                                                        <option value="Chadian">Chadian
                                                                                        </option>
                                                                                        <option value="Chilean">Chilean
                                                                                        </option>
                                                                                        ...
                                                                                        <option value="Guinean">Guinean
                                                                                        </option>
                                                                                        <option value="Guyanese">
                                                                                            Guyanese
                                                                                        </option>
                                                                                        <option value="Haitian">Haitian
                                                                                        </option>
                                                                                        ...
                                                                                        <option value="Iraqi">Iraqi
                                                                                        </option>
                                                                                        <option value="Irish">Irish
                                                                                        </option>
                                                                                        <option value="Israeli">Israeli
                                                                                        </option>
                                                                                        <option value="Italian">Italian
                                                                                        </option>
                                                                                        <option value="Ivorian">Ivorian
                                                                                        </option>
                                                                                        ...
                                                                                        <option
                                                                                            ...
                                                                                            Kittian
                                                                                            and Nevisian</option>
                                                                                        <option value="Kuwaiti">Kuwaiti
                                                                                        </option>
                                                                                        <option value="Kyrgyz">Kyrgyz
                                                                                        </option>
                                                                                        <option value="Laotian">Laotian
                                                                                        </option>
                                                                                        ...
                                                                                        <option value="Omani">Omani
                                                                                        </option>
                                                                                        <option value="Pakistani">
                                                                                            Pakistani
                                                                                        </option>
                                                                                        <option value="Palauan">Palauan
                                                                                        </option>
                                                                    ...
                                                                    <div class="col-lg-12 ReasonColumn">
                                                                        <div class="form-group">
                                                                            <label class="form-label">Please enter a
                                                                                reason
                                                                                why</label>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group editable-field"
                                                                            data-type="text">
                                                                            <label class="form-label">Personal Email
                                                                                Address (Do
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group editable-field"
                                                                            ...
                                                                            <div class="EditbleData_wrap">
                                                                                <div class="form-content">
                                                                                    <span class="form-text">Academy of
                                                                                        Natural
                                                                                        Therapies</span>
                                                                                    <input type="text"
                                                                                        class="form-control d-none"
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group editable-field"
                                                                            ...
                                                                            <div class="EditbleData_wrap">
                                                                                <div class="form-content">
                                                                                    <span class="form-text">Fundamentals
                                                                                        of
                                                                                        Cybersecurity</span>
                                                                                    <input type="text"
                                                                                        class="form-control d-none"
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group editable-field"
                                                                                ...
                                                                                <div class="EditbleData_wrap">
                                                                                    <div class="form-content">
                                                                                        <span
                                                                                            class="form-text">Australia</span>
                                                                                        <!-- Initially shows only selected option text -->
                                                                                        <select
                                                                                            class="form-control select2 d-none"
                                                                                            style="display:none;">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select id="RentedOwnhouse_option"
                                                                                    ...
                                                                                    <option disabled selected value="">
                                                                                        ...
                                                                                        Select...</option>
                                                                                    <option
                                                                                        value="Rented Accommodation">
                                                                                        Rented
                                                                                        Accommodation</option>
                                                                                    <option value="Parents House">
                                                                                        Parents House
                                                                                    </option>
                                                                ...
                                                                <div class="address_Fields_container">
                                                                    <div class="form_seperation_title">
                                                                        <h2>Home Address (for non-UK residents please
                                                                            provide
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group editable-field"
                                                                                ...
                                                                                <div class="EditbleData_wrap">
                                                                                    <div class="form-content">
                                                                                        <span
                                                                                            class="form-text">123456789</span>
                                                                                        <input type="text"
                                                                                            class="form-control d-none"
                                                                                            value="123456789">
                                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            <div class="form-group editable-field"
                                                                                data-type="text">
                                                                                <div class="form-label-group">
                                                                                    <label>Is there anything else you
                                                                                        consider
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            <div class="form-group editable-field"
                                                                                data-type="text">
                                                                                <div class="form-label-group">
                                                                                    <label>What has attracted you to a
                                                                                        Rent a
                                                                ...
                                                                <div class="address_Fields_container"
                                                                    id="GuranterAddress" style="display: none;">
                                                                    <div class="form_seperation_title">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group editable-field"
                                                                                data-type="text">
                                                                                <label class="form-label">Guarantor Date
                                                                                    of
                                                                                    Birth</label>

                                                                                <div class="EditbleData_wrap">
                                                                                    <div class="form-content">
                                                                                        <span class="form-text">January
                                                                                            15,
                                                                                            1980</span>
                                                                                        <input
                                                                                            class="form-control d-none customdataPicker flatpickr-input"
                                                                ...
                                                                <div class="address_Fields_container"
                                                                    id="GuranterBank_details" style="display: none;">
                                                                    <div class="form_seperation_title">
                                                                        <h2>Guarantor Bank Details (for credit check
                                                                            purposes
                                                                            only)</h2>
                                                                    </div>
                                                                    <div class="row">
                                                                ...
                                                                <div class="address_Fields_container">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group editable-field"
                                                                                data-type="select">
                                                                                <label class="form-label">How did you
                                                                                    find
                                                                                    us?</label>
                                                                                ...
                                                                                <div class="EditbleData_wrap">
                                                                                    <div class="form-content">
                                                                                        ...
                                                                                        <select
                                                                                            ...
                                                                                            <option value="UniHomes">
                                                                                                UniHomes
                                                                                            </option>
                                                                                            <option value="UniAcco">
                                                                                                UniAcco
                                                                                            </option>
                                                                                            <option
                                                                                                value="Amber Students">
                                                                                                Amber
                                                                                                Students</option>
                                                                                            <option value="UHomes">
                                                                                                UHomes
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="Enquiry_Terms_content">
                                                                                        ...
                                                                                        <p>I hereby confirm that I am
                                                                                            ...
                                                                                            completion and hereby
                                                                                            authorise the
                                                                                            landlord or their agent to:
                                                                                        </p>
                                                                                        <ul>
                                                                                            <li>carry out credit
                                                                                                searches and
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="Enquiry_Terms_content">
                                                                                        ...
                                                                                        <ul>
                                                                                            ...
                                                                                            <li>that my application will
                                                                                                be
                                                                                                voided if the tenancy
                                                                                                agreement
                                                                                                and relevant
                                                                                                documentation is
                                                                                                not provided within one
                                                                                                week
                                                                                                of receiving the
                                                                                                agreement; the
                                                                                                property will be
                                                                                                re-advertised with view
                                                                                                to
                                                                                                Graysons Properties
                                                                                                finding
                                                                                                another tenant</li>
                                                                ...
                                                                <div class="address_Fields_container">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            <div class="form-group">
                                                                                <div class="Enquiry_Terms_content">
                                                                                    <p>This is to secure the property
                                                                                        and will
                                                                                        be deducted from the first
                                                                                        months’ rent on move in. Should
                                                                                        the
                                                                                        tenancy fail to proceed after 14
                                                                                        days of payment (or a different
                                                                                        deadline
                                                                                        for the agreement in
                                                                                        writing), the ‘rent advance’
                                                                                        does not
                                                                                        need to be refunded if the
                                                                                        tenant: Withdraws out of the
                                                                                        agreement
                                                                                        themselves, Fails the right
                                                                                        to rent check, Has provided
                                                                                        false or
                                                                                        misleading information Or, the
                                                                                        landlord has tried their best to
                                                                                        get the
                                                ...
                                                <header class="task-header taskheader_noPadding">
                                                                ...
                                                                <div class="dropdown statusChange_dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu"
                                                                        ...
                                                                        <li><a class="dropdown-item" href="#"
                                                                                data-color="bg-success"> Ready For
                                                                                Contract
                                                                            </a></li>
                                                                        <li><a class="dropdown-item" href="#"
                                                                                data-color="bg-warning">Application
                                                                                Received</a></li>

                                                                        <li><a class="dropdown-item" href="#"
                                                                                data-color="bg-warning"> Reference Check
                                                                                issued </a></li>
                                                                        <li><a class="dropdown-item" href="#"
                                                                                data-color="bg-warning"> Awaiting
                                                                                Details </a></li>
                                                                        <li><a class="dropdown-item" href="#"
                                                                                data-color="bg-warning"> Awaiting Room
                                                                                Allowcation</a></li>
                                                                        <li><a class="dropdown-item" href="#"
                                                                                data-color="bg-warning"> Awaiting
                                                                                Tenancy Setup </a></li>
                                                    ...
                                                    <div class="enquiryRight_header_data TaskAction_wrapper">
                                                        <div class="enquiryDate dueDate_container">
                                                            ...
                                                            <div class="duedatelabel">Last Updated on : </div> Nov 20,
                                                            2024
                                                        </div>
                                                        <div class="enquiryID_container">
                                                            ...
                                                            <div class="IDButton appoinment_confirmed">
                                                                <button type="button" class="SourceDataBtn"> Application
                                                                    Received
                                                                </button></div>
                                                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit"
                    class="canvasSubmit_button commonCanvas_buttonFooter confirm-edit">Confirm</button>
