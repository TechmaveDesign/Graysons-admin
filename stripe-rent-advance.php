                        ...
                        <div class="fullwidthDesktopTabs MobileScrollShow" id="nopaddingTop">
                            ...
                            <ul class="nav SubTabInvoice nav-tabs nav-line nav-icon fullwidthCustom_tabsUL nav-light">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#TenantInv">
                                        <div class="d-flex align-items-center">
                                            <span class="nav-link-text">Disputed Payments</span>
                                ...
                                <div class="fullwidthDesktopTabs MobileScrollShow innerUserContract_tabs">
                                                ...
                                                <ul
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-bs-toggle="tab"
                                                            href="#ProcessingPayment1">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Processing Payments </span>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            href="#PaymentFailed1">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Failed Payments </span>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            href="#SuccessPayments1">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Success Payments </span>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            href="#PaymentSettled1">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Settled Payments </span>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    <!-- <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            href="#PaymentSettled1">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Payment Settled</span>
                                                            </div>
                                                        </a>
                                                    </li> -->
                                                </ul>
                                    ...
                                    <div class="contact-list-view">
                                        ...
                                        <div class="tab-content tabContent_hiddenStyle">
                                            <div class="tab-pane fade show active" id="ProcessingPayment1">
                                                <table class="table common-datatable nowrap w-100 ">
                                                                ...
                                                                <a href="stripe-detail-page.php"
                                                                    ...
                                                                    data-bs-original-title="View Payment Details"><span
                                                                        class="icon"><span
                                                                            ...
                                                                            <a href="#"  onclick="handleApproveClick()" 
                                                                    class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover "
                                                                    data-bs-toggle="tooltip"
                                                                    data-placement="top" title=""
                                                    ...
                                                    <div class="d-flex align-items-center ActionDropdown">
                                                        ...
                                                        <div class="tab-pane fade" id="PaymentFailed1">
                                                            <table class="table common-datatable nowrap w-100 ">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Tenant Name</th>
                                                        ...
                                                        <div class="tab-pane fade" id="SuccessPayments1">
                                                                <table class="table common-datatable nowrap w-100 ">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Tenant Name</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <td>£10</td>
                                                                        <td>£290</td>
                                                                        <td><span class="badge badge-soft-success  my-1  me-2">Success</span></td>
                                                        ...
                                                        <div class="tab-pane fade" id="PaymentSettled1">
                                                                <table class="table common-datatable nowrap w-100 ">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Tenant Name</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <td>£10</td>
                                                                        <td>£290</td>
                                                                        <td><span class="badge badge-soft-success  my-1  me-2">Settled</span></td>
                                ...
                                <div class="fullwidthDesktopTabs MobileScrollShow innerUserContract_tabs">
                                            ...
                                            <div class="usercontracttab_contrainer">
                                                <ul
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-bs-toggle="tab"
                                                            href="#ProcessingPayment2">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Refund Processing Payments </span>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            href="#PaymentFailed2">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Refund Failed Payments </span>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            href="#SuccessPayments2">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Refunded Payments </span>
                                    ...
                                    <div class="contact-list-view">
                                        ...
                                        <div class="tab-content tabContent_hiddenStyle">
                                            <div class="tab-pane fade show active" id="ProcessingPayment2">
                                                <table class="table common-datatable nowrap w-100 ">
                                                    <thead>
                                                        <tr>
                                                            <th>Tenant Name</th>
                                                    ...
                                                    <div class="d-flex align-items-center ActionDropdown">
                                                        ...
                                                        <div class="tab-pane fade" id="PaymentFailed2">
                                                            <table class="table common-datatable nowrap w-100 ">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Tenant Name</th>
                                                        ...
                                                        <div class="tab-pane fade" id="SuccessPayments2">
                                                                <table class="table common-datatable nowrap w-100 ">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Tenant Name</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <td>£10</td>
                                                                        <td>£290</td>
                                                                        <td><span class="badge badge-soft-success  my-1  me-2">Refunded</span></td>
                                ...
                                <div class="fullwidthDesktopTabs MobileScrollShow innerUserContract_tabs">
                                            ...
                                            <div class="usercontracttab_contrainer">
                                                <ul
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-bs-toggle="tab"
                                                            href="#ResponsePayment">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Needs Response</span>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            href="#ReviewPayment">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Under Review</span>
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab"
                                                            href="#WonPayment">
                                                            <div class="d-flex align-items-center">
                                                                <span class="nav-link-text">Won</span>
                                    ...
                                    <div class="contact-list-view">
                                        ...
                                        <div class="tab-content tabContent_hiddenStyle">
                                            <div class="tab-pane fade show active" id="ResponsePayment">
                                                            <table class="table common-datatable nowrap w-100 ">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Tenant Name</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>Dec 12,2024 4:21 PM</td>
                                                                        <td>
                                                                            <svg class="SVGInline-svg SVGInline--cleaned-svg SVG-svg BrandIcon-svg BrandIcon--size--20-svg" height="20" width="20" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="M0 0h32v32H0z" fill="#00579f"></path><g fill="#fff" fill-rule="nonzero"><path d="M13.823 19.876H11.8l1.265-7.736h2.023zm7.334-7.546a5.036 5.036 0 0 0-1.814-.33c-1.998 0-3.405 1.053-3.414 2.56-.016 1.11 1.007 1.728 1.773 2.098..."></path></g></g></svg>
                                                                            •••• 4345
                                                                        </td>
                                                                        <td>£300</td>
                                                                        <td>£10</td>
                                                                        ...
                                                                        <td>dsp_123456</td>
                                                                        <td>ch_789012</td>
                                                                        <td><span class="badge badge-soft-info  my-1  me-2">Needs Response</span></td>
                                                                        <td>Fraudulent</td>
                                                                        <td>Receipts submitted, customer communication pending</td>
                                                                        <td>2025-03-01</td>
                                                                        <td>
                                                                            <a href="dist/img/newimages/inspection_report_126.pdf" download="invoice.pdf" target="_blank">invoice.pdf</a>, 
                                                                            <a href="dist/img/newimages/inspection_report_126.pdf" download="communication_logs.pdf" target="_blank">communication_logs.pdf</a>
                                                                        </td>
                                                                        <td>
                                                                            <div class="d-flex align-items-center ActionDropdown">
                                                                                <div class="d-flex">
                                                                                    <a href="stripe-detail-page.php" class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover " data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="View Payment Details">
                                                                                        <span class="icon"><span class="feather-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg></span></span>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                        ...
                                                        <div class="tab-pane fade" id="ReviewPayment">
                                                        <table class="table common-datatable nowrap w-100 ">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Tenant Name</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>dsp_123456</td>
                                                                        <td>ch_789012</td>
                                                                        <td><span class="badge badge-soft-warning  my-1  me-2">Under Review</span></td>
                                                                        <td>Fraudulent</td>
                                                                        <td>Receipts submitted, customer communication pending</td>
                                                                        <td>2025-03-01</td>
                                                                        <td>
                                                        ...
                                                        <div class="tab-pane fade" id="WonPayment">
                                                        <table class="table common-datatable nowrap w-100 ">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Tenant Name</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>dsp_123456</td>
                                                                        <td>ch_789012</td>
                                                                        <td><span class="badge badge-soft-success  my-1  me-2">Won</span></td>
                                                                        <td>Fraudulent</td>
                                                                        <td>Receipts submitted, customer communication pending</td>
                                                                        <td>2025-03-01</td>
                                                                        <td>
        ...
        if (result.isConfirmed) {
            ...
            if (enteredMpin === DUMMY_MPIN) {
                Swal.fire({
                    ...
                    Swal.close();
                    setTimeout(() => {
                        var modalElement = document.getElementById('AddHubEvent');
