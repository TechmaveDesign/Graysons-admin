                        ...
                        <div class="d-flex align-items-center">
                            <div class="dropdown">
                                <a class="contactapp-title link-dark" href="##" role="button">
                                    <h1>Edit Supplier & Item Details</h1>
                                </a>
                            ...
                            <div class="formstartcontainer">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="docFilterContainer">
                                            <div class="docfilterbutton">
                                                <h2 class="tabinnerTitle">Supplier Details</h2>
                                ...
                                <div class="row">
                                   <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="form-label">Item Title<span
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="Contact" class="form-label">Upload Item Description Document</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="Contact" class="form-label">Attach Quotation File</label>
                                            <!-- File Input with Dropify -->
                                    ...
                                    <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-label">Upload Item Images</label>
                                ...
                                <div class="FormsActionGroup">
                                    <a href="procurement-team-request-detail-page.php"><button type="button" class="canvascancel_button commonCanvas_buttonFooter">Cancel</button></a>
                                    <a href="procurement-team-request-detail-page.php"><button type="button" class="canvasSubmit_button commonCanvas_buttonFooter">Submit</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
