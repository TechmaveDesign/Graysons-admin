        ...
        <div class="contactapp-wrap">
            ...
            <div class="contactapp-content">
                <div class="contactapp-detail-wrap">
                    ...
                    <ul class="nav nav-tabs nav-line nav-icon fullwidthCustom_tabsUL nav-light">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " data-bs-toggle="tab" href="#AddDevelopmenttb">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-text">Application Activity</span>
                                </div>
                            </a>
                        </li>
                    ...
                    <form action="contract-statuses.php" method="POST">
                            ...
                            <div class="nicescroll-bar">
                                ...
                                <div class="ApplicationForm_wrapper">
                                    ...
                                    <div class="offcanvas-body">
                                        ...
                                        <div class="tab-content  notpMargin_tab applicants_inr_tabContent">
                                            <div class="tab-pane fade show active" id="AddPropertytb">
                                                <div class="contact-list-view">

                                                    <div class=" ApplicationFrm_wrapper">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group editable-field"
                                                                                data-type="select">
                                                                                <label class="form-label">How Long You
                                                                                    have lived in
                                                                                    UK (for Non-British
                                                                                    Citizens)</label>
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="pn-select" id="js_pn-select"
                                                                                    ...
                                                                                    <div class="pn-input">
                                                                                        <div
                                                                                            class="pn-input__container">
                                                                                            <input
                                                                                                class="pn-input__prefix"
                                                                                                value="+31" type="text"
                                                                    ...
                                                                    <div class="address_Fields_container">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4">
                                                                                <div class="form-group editable-field"
                                                                                    data-type="text">
                                                                                    <label class="form-label">Providence
                                                                                        of
                                                                                        State</label>
                                                                                    <div class="EditbleData_wrap">
                                                                                        <div class="form-content">
                                                                    ...
                                                                    <div class="address_Fields_container">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <div class="form-group">
                                                                                    <label class="form-label">Rented OR
                                                                                        Own
                                                                                        House</label>
                                                                    ...
                                                                    <div class="address_Fields_container">
                                                                        <div class="form_seperation_title">
                                                                            <h2>Home Address (for non-UK residents
                                                                                please provide
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div class="form-group editable-field"
                                                                                    data-type="text">
                                                                                    <div class="form-label-group">
                                                                                        <label>What has attracted you to
                                                                                            a Rent a
                                                                    ...
                                                                    <div class="address_Fields_container">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group editable-field"
                                                                                    data-type="select">
                                                                                    <label class="form-label">How did
                                                                                        you find
                                                                                        us?</label>
                                                                        ...
                                                                        <div class="TermsContent_wrapper">
                                                                            <div class="row">
                                                                                <div class="col-lg-12">
                                                                                    <div class="form-group">
                                                                                        <div
                                                                                            class="Enquiry_Terms_content">
                                                                                            <h2>Declaration</h2>
                                                                                            <p>I hereby confirm that I
                                                                                                am over 18
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <div
                                                                                        class="form-group largeCheckGroup">
                                                                                        <label for=""
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-12">
                                                                                    <div class="form-group">
                                                                                        <div
                                                                                            class="Enquiry_Terms_content">
                                                                                            <p>Graysons Properties
                                                                                                complies with
                                                                                                GDPR Regulations and
                                                                                                will
                                                                                                always act in the best
                                                                                                interests of
                                                                                                its clients in relation
                                                                                                to
                                                                            ...
                                                                            <div class="col-lg-12">
                                                                                <div class="form-group">
                                                                                    <div class="Enquiry_Terms_content">
                                                                                        <p>This is to secure the
                                                                                            property and will
                                                                                            be deducted from the first
                                                                                            months’ rent on move in.
                                                                                            Should the
                                                                                            tenancy fail to proceed
                                                                                            after 14
                                                                                            days of payment (or a
                                                                                            different deadline
                                                            ...
                                                            <ul
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link active" data-bs-toggle="tab"
                                                                        href="#tab_comments">
                                                                        <span
                                                                            class="nav-link-text badge-on-text">Comments</span>
                                                                    </a>
                                                                </li>
