                                ...
                                <ul class="nav nav-tabs nav-line nav-icon fullwidthCustom_tabsUL nav-light">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#AddPropertytb">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text">Edit Property</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link " data-bs-toggle="tab" href="#AddDevelopmenttb">
                                            <div class="d-flex align-items-center">
                                                <span class="nav-link-text">Edit Development</span>
                                            </div>
                                        </a>
                                    </li>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="form-group">
                                                                                <label for="" class="form-label">Access
                                                                                    Code</label>
                                                                                <input type="text" class="form-control"
                                                                                    id="" value="AFG98012">
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="" id=""
                                                                                    ...
                                                                                    <option value="22" selected>Properties, SR
                                                                                    </option>
                                                                                    <option value="27">Ghai, Harjit
                                                                                    </option>
                                                                                    <option value="239">Somal, Mohinder
                                                                                    </option>
                                                                                    <option value="301">Ghai, Shashi
                                                                                    </option>
                                                                                    <option value="302">Somal, Inderjeet
                                                                                    </option>
                                                                                    <option value="304">Sunderland Ltd,
                                                                                        City View</option>
                                                                                    <option value="310">Ghai
                                                                                        Investments, Somal</option>
                                                                                    <option value="320">Sunderland Ltd,
                                                                                        Phoenix House
                                                                                    </option>
                                                                                    <option value="323">Developments
                                                                                        Ltd, Graystones
                                                                                    </option>
                                                                                    <option value="364">Nayyar, Neeraj
                                                                                    </option>
                                                                                    <option value="401">Hussain, Zak
                                                                                    </option>
                                                                                    <option value="437">Development, SSG
                                                                                        Property</option>
                                                                                    ...
                                                                                    <option value="1892">Malhi, Navjit
                                                                                    </option>
                                                                                    <option value="2087">Somal,
                                                                                        Deepinder</option>
                                                                                    <option value="2088">Services Ltd,
                                                                                        Union Property
                                                                                    </option>
                                                                                </select>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="" id="propertyType"
                                                                                    ...
                                                                                    <option disabled="" selected=""
                                                                                        value="">Please
                                                                                        Select...</option>
                                                                                    <option value="Building" selected>Building
                                                                                    </option>
